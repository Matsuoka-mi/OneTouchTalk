...
class View4: UIViewController, UIGestureRecognizerDelegate, AVAudioPlayerDelegate {
    ...
    override func viewDidLoad() {
        ...
        switch self.view4gazo{
        case 1 :
            image4View.image = UIImage(named: "black")
     
            
        case 2 :
            image4View.image = UIImage(named: "white")
     
            
        case 3 :
            image4View.image = UIImage(named: "red")
            
            
        case 4:
            image4View.image = UIImage(named: "blue")
        case 5:
            image4View.image = UIImage(named: "green")
        case 6:
            image4View.image = UIImage(named: "yellow")
            
        case 7:
            image4View.image = UIImage(named: "pink")
        case 8:
            image4View.image = UIImage(named: "orange")
        case 9:
            image4View.image = UIImage(named: "purple")
            
        default:
            image4View.image = UIImage(named: "gazounashi")
