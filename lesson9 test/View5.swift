...
class View5: UIViewController, UIGestureRecognizerDelegate, AVAudioPlayerDelegate {
    ...
    override func viewDidLoad() {
        ...
        switch self.view5gazo{
        case 1 :
            image5View.image = UIImage(named: "black")
     
            
        case 2 :
            image5View.image = UIImage(named: "white")
     
            
        case 3 :
            image5View.image = UIImage(named: "red")
            
            
        case 4:
            image5View.image = UIImage(named: "blue")
        case 5:
            image5View.image = UIImage(named: "green")
        case 6:
            image5View.image = UIImage(named: "yellow")
            
        case 7:
            image5View.image = UIImage(named: "pink")
        case 8:
            image5View.image = UIImage(named: "orange")
        case 9:
            image5View.image = UIImage(named: "purple")
            
        default:
            image5View.image = UIImage(named: "gazounashi")
