...
class View6: UIViewController, UIGestureRecognizerDelegate, AVAudioPlayerDelegate {
    ...
    override func viewDidLoad() {
        ...
        switch self.view6gazo{
        case 1 :
            image6View.image = UIImage(named: "black")
     
            
        case 2 :
            image6View.image = UIImage(named: "white")
     
            
        case 3 :
            image6View.image = UIImage(named: "red")
            
            
        case 4:
            image6View.image = UIImage(named: "blue")
        case 5:
            image6View.image = UIImage(named: "green")
        case 6:
            image6View.image = UIImage(named: "yellow")
            
        case 7:
            image6View.image = UIImage(named: "pink")
        case 8:
            image6View.image = UIImage(named: "orange")
        case 9:
            image6View.image = UIImage(named: "purple")
            
        default:
            image6View.image = UIImage(named: "gazounashi")
